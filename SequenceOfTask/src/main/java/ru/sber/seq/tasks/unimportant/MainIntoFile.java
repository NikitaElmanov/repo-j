...
public class MainIntoFile {
    ...
    public static void main(String[] args) {
        ...
        steps.add(
                new Step.StepBuilder(0, "This is Step 0")
                        .setGoThen(Arrays.asList(1, 2, 6))
                        .build());
        steps.add(
                new Step.StepBuilder(1, "This is Step 1")
                        .setGoThen(Arrays.asList(3))
                        .setParallelWith(Arrays.asList(2, 6))
                        .build());
        steps.add(
                new Step.StepBuilder(2, "This is Step 2")
                        .setGoThen(Arrays.asList(4))
                        .setParallelWith(Arrays.asList(1, 6))
                        .build());
        steps.add(
                new Step.StepBuilder(3, "This is Step 3")
                        .setGoThen(Arrays.asList(5))
                        .setParallelWith(Arrays.asList(4))
                        .build());
        steps.add(
                new Step.StepBuilder(4,"This is Step 4")
                        .setGoThen(Arrays.asList(5))
                        .setParallelWith(Arrays.asList(3))
                        .build());
        steps.add(
                new Step.StepBuilder(5,"This is Step 5")
                        .build());
        steps.add(
                new Step.StepBuilder(6, "This is Step 6")
                        .setGoThen(Arrays.asList(3))
